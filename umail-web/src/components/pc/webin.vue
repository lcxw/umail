	...
	<div class="ums-page">
		<div class="form-box">
			<el-form ref="form" class="login-form" :model="user">
			  <el-form-item>
				<el-input v-model="user.name"  size="small"  placeholder="用户名/邮箱" style="width:250px">
				</el-input>
			  </el-form-item>
				<el-form-item>
			  ...
			  <el-form-item>
				...
				size="small"
				:disabled="false"
				 style="width:250px;height:40px;font-size:1.1em;color: #ffffff;background-color: #409EFF;border-color: transparent;" @click="login">登录</el-button>
			  </el-form-item>
			</el-form>
