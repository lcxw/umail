...
public class UMailUtils {
    ...
    public static Path getConfigBase() {
        return Paths.get(System.getProperty("user.home"), ".umail");
    }

    public static Path getServerConfig() {
        return getConfigBase().resolve(Paths.get("conf","ServerConf.xml"));
    }
}
